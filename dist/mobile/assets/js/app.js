...
'use strict'
	...
	const log = document.querySelector('.datalog')
	...
	function geolocate () {
		if (navigator.geolocation) {
			...
			let success = position => {
				pos = position
				location = position
				meta.innerHTML = 'You are here<br>' + pos.coords.latitude + ' | ' + pos.coords.longitude
				preload()
			}

			let error = error => {
				console.log(error)
				meta.innerHTML = 'Could\'t find you'
				preload()
			}
	...
	function info() {
		infopanel.classList.toggle('info-hidden')
